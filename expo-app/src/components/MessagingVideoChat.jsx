        ...
        <SafeAreaView style={styles.chatContainer}>
            ...
            >
                ...
                <View style={styles.chatHeader}>
                    ...
                    {/* Call button + call screen, shown at the right of the header */}
                    {appSocket && (
                        <VoiceCall
                            externalSocket={appSocket}
                            currentUserId={currentUserId}
...
const styles = StyleSheet.create({
    listContainer: { flex: 1, width: '100%', maxWidth: 820, alignSelf: 'center', backgroundColor: '#f9fafb', paddingHorizontal: 12, paddingTop: 8 },
    ...
    chatContainer: { flex: 1, width: '100%', maxWidth: 820, alignSelf: 'center', backgroundColor: '#fff' },
    chatHeader: {
